...
#Best objective 1.049229181250e+03, best bound 1.048713945055e+03, gap 0.0491%
```
...
```{r}
### Now lets try setting a boundary length of 0..001
...
plot(sprob_ports_blm,  main = c("Ports: BLM = 0.001"))

writeRaster(sprob_ports_blm, here('outputs/ports_001.tif'), overwrite = TRUE)
```
...
writeRaster(sprob_ports_blm_1, here('outputs/ports_1.tif'), overwrite = TRUE)
...
writeRaster(sprob_ports_no_mpas, here('outputs/ports_mpas.tif'), overwrite = TRUE)

#Optimal solution found (tolerance 1.00e-01)
#Best objective 1.046915289600e+03, best bound 1.046556968228e+03, gap #0.0342%
...
writeRaster(sprob_ports_10, here('outputs/ports_10.tif'), overwrite = TRUE)
```
...
writeRaster(sprob_ports_50, here('outputs/ports_50.tif'), overwrite = TRUE)
