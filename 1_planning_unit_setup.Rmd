...
mz_rast_id_100 <- raster::raster(x=mz_ext, crs=crs(mz_eez_sf), res=1000) 
...
pa_shape <- list.files(exist_mpa_path, full.names = TRUE)
...
oil_raster <- raster(here('G:/group_project/Data/Oil_rigs/oil_rig_2013_halpern_et_al_2015_clipped.tif'))
