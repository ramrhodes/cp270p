...
```{r}
## Bring in MZ raster that was created in Script 1
...
# save as raster
writeRaster(coral_agg_percent, here('rasters/coral.tif'), overwrite = TRUE)
...
features_stack <- stack(coral_raster, mangroves_raster, seagrass_raster, seamount_raster, knolls_raster)
